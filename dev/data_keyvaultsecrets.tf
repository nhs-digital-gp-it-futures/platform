...
data "azurerm_key_vault_secret" "kv-tenant" {
  ...
  key_vault_id = "/subscriptions/7b12a8a2-f06f-456f-b6f9-aa2d92e0b2ec/resourceGroups/gpitfutures-dev-rg-kv/providers/Microsoft.KeyVault/vaults/gpitfutures-kv-dev"
}
