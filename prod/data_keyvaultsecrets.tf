...
data "azurerm_key_vault_secret" "kv-tenant" {
  ...
  key_vault_id = "/subscriptions/d1be8dbc-1a9f-4b7b-ba51-037116110e00/resourceGroups/gpitfutures-prod-rg-kv/providers/Microsoft.KeyVault/vaults/gpitfutures-prod-kv"
}
